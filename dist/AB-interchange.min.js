...
"use strict";window.AB=require("ab-mediaquery");var t="abInterchange",e="data-ab-interchange",i="data-ab-interchange-src",s={mode:"img",lazySettings:{offscreen:1.25,delayed:!1,layout:"fluid"}},n=function(){if(!this._replaced)switch(this.mode){case"img":l.call(this);break;case"lazy-img":l.call(this,!0);break;case"background":a.call(this);break;case"lazy-background":a.call(this,!0)}},l=function(t){this._imgNode.src===this.currentPath||t&&!this.inView()||(this._imgNode.src=this.currentPath,this._imgNode.addEventListener("load",o.bind(this)),this._replaced=!0)},a=function(t){this.el.style.backgroundImage==='url("'+this.currentPath+'")'||t&&!this.inView()||(this.currentPath?this.el.style.backgroundImage="url("+this.currentPath+")":this.el.style.backgroundImage="none",this.el.addEventListener("load",o.bind(this)))},h=function(){var t=this;("PICTURE"===this.el.parentNode.tagName||this.el.getAttribute("srcset"))&&window.HTMLPictureElement||(this.settings.lazySettings.delayed&&(this._lazyTimer=setTimeout(function(){n.call(t)},this.settings.lazySettings.delayed)),r.call(this),d.call(this),c.call(this),g.call(this))},r=function(){var t=document.createElement("div"),e=document.createElement("img"),i=this.el.getAttribute("alt"),s=w.call(this),n=s.width,l=s.height,a=!n||!l;"lazy-img"!==this.mode||a||(this.el.innerHTML="",this.el.style.overflow="hidden",this.el.style.position="relative",this.el.classList.add("ab-interchange-loading"),"fixed"===this.settings.lazySettings.layout&&(this.el.style.height=l+"px",this.el.style.width=n+"px"),t.classList.add("ab-interchange-placeholder"),t.style.paddingTop=(l/n*100).toFixed(2)+"%",e.style.position="absolute",e.style.top=0,e.style.right=0,e.style.bottom=0,e.style.left=0,e.style.maxHeight="100%",e.style.minHeight="100%",e.style.maxWidth="100%",e.style.minWidth="100%",e.style.height=0,e.alt=null===i?"":i,this.el.appendChild(t),this.el.appendChild(e),this._imgNode=this.el.querySelector("img"))},o=function(){this.el.classList.remove("ab-interchange-loading");var t=new CustomEvent("replaced.ab-interchange",{detail:{element:this.el}});window.dispatchEvent(t)},d=function(){var t="";window.addEventListener("changed.ab-mediaquery",this.resetDisplay.bind(this)),"lazy-img"!==this.mode&&"lazy-background"!==this.mode||("IntersectionObserver"in window?(t=parseInt((this.settings.lazySettings.offscreen-1)*window.innerHeight)+"px",new IntersectionObserver(u.bind(this),{root:null,rootMargin:"0px 0px "+t+" 0px",threshold:0}).observe(this.el)):window.addEventListener("ab-scroll",u.bind(this)))},c=function(){for(var t=[],s=(this.el.getAttribute(i)?this.el.getAttribute(i):this.el.getAttribute(e)).match(/\[[^\]]+\]/g),n=0,l=s.length;n<l;n++){var a=s[n].slice(1,-1).split(", "),h=a.slice(0,-1).join(""),r=a[a.length-1];t.push({path:h,query:r})}this.rules=t},g=function(){for(var t="",e=this.rules,i=0,s=e.length;i<s;i++)window.AB.mediaQuery.is(e[i].query)&&(t=e[i].path);this.currentPath!==t&&(this.currentPath=t,n.call(this))},u=function(){this.inView()&&!this._replaced&&(clearTimeout(this._lazyTimer),n.call(this))},m=function(){return"IMG"===this.el.tagName?"img":this.settings.mode},w=function(){var t=this.el.getAttribute("width"),e=this.el.getAttribute("height"),i={},s={};if(window.AB.isJson(t)&&window.AB.isJson(e))for(var n in i=JSON.parse(t),s=JSON.parse(e),i)i.hasOwnProperty(n)&&window.AB.mediaQuery.is(n)&&(t=i[n],e=s[n]);return{width:t,height:e}},y=function(t,i){this.el=t;var n=window.AB.isJson(this.el.getAttribute(e))?JSON.parse(this.el.getAttribute(e)):{};this.settings=window.AB.extend(!0,s,i,n),this.rules=[],this.currentPath="",this.mode=m.call(this),this.replaced=!1,this._lazyTimer,this._imgNode=this.el,h.call(this)};y.prototype={resetDisplay:function(){this._replaced=!1,r.call(this),g.call(this)},inView:function(){var t=window.innerHeight,e=this.el.getBoundingClientRect(),i=-this.el.offsetHeight-t*(this.settings.lazySettings.offscreen-1),s=t+t*(this.settings.lazySettings.offscreen-1);return e.top>=i&&e.top<=s}};var p=function(i){for(var s=document.querySelectorAll("["+e+"]"),n=0,l=s.length;n<l;n++)s[n][t]||(s[n][t]=new y(s[n],i));window.AB.options[t]||(window.AB.options[t]=i)};window.AB.plugins.interchange=p,module.exports=window.AB;
